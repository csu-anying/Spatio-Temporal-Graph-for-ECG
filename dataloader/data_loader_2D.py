...
class DataGen_2D(torch.utils.data.Dataset):
    ...
    def __init__(self, data, label):
        super(DataGen_2D, self).__init__()
...
def data_generator_2D(data_path, k,  args):
    ...
    train_gen = DataGen_2D(train_dataset, train_label)
    val_gen = DataGen_2D(valid_dataset, valid_label)
    test_gen = DataGen_2D(test_dataset, test_label)
